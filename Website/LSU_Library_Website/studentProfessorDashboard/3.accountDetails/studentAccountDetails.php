          ...
          <div style="width: 100%;
            ...
            <div style="width: 55%;
              ...
              <div id="container">
                ...
                <table>
                  ...
                  <tr>
                    ...
                    <td> <p class="containerUserDataTextStyle">Student </p> <td>
                  </tr>
                ...
                <button type="button" name="changePassword" style="color: #FFFFFF;
                                                                  ...
                                                                  position: absolute;
                                                                  top: 960px;
                                                                  left: 90px;" onClick="window.location.href = 'studentProfessorChangePassword.php';">
              ...
              <button type="button" name="updateDetails" style="color: #FFFFFF;
                                                                ...
                                                                position: absolute;
                                                                top: 1150px;
                                                                left: 690px;" onClick="window.location.href = 'studentUpdateDetails.php';">
