<?php
  ...
  if(isset($_POST['creturndetails'])){

    $currentISBN = $_GET['returnisbn'];
          ...
          <div style="width: 100%;
            ...
            <div style="width: 55%;
              ...
              <p style="font-size: 30px;
                        padding-top: 25px;
                        margin-left: 40px;
                        text-align: center;"><b>Update Return Details</b></p>
              ...
              <div id="container">
                ...
                <form action="updateReturnDetails.php?returnisbn=<?php echo $_GET['returnisbn']; ?>&borrowid=<?php echo $_GET['borrowid']; ?>&userusername=<?php echo $_GET['userusername']; ?>"
                  method="POST">
                  ...
                  data-toggle="tooltip" data-placement="right" value="<?php echo $_GET['returnisbn']; ?>">
                  ...
                  <button type="submit" name="creturndetails" id="updateSubmitButton">Update Details</button>
